...
<br>
파이널 프로젝트 주제 : 상품 자동 주문 및 딜리버리 관리 웹 서비스 시스템<br>
주제 선정 이유 : 쇼핑몰과 상품 자동 주문 딜리버리 시스템의 2가지 주제 중에 좀 더 재미있고 큰 프로젝트가 자동 주문 딜리버리 시스템이라 <br>
생각되었기 때문에 해당 주제를 선정 
<br>
Final Project 개발 기간<br>
총 개발 기간 : 2024.08.17 ~ 2024.10.04<br>
